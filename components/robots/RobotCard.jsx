        ...
        <article className="flex flex-col justify-between w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33%-1.75rem)] border rounded-lg shadow-md bg-gray-800 border-gray-700">
            <div>
                <header>
                    ...
                    />
                    <h2 className="mb-2 pt-5 px-5 text-2xl text-center font-bold tracking-tight text-white">{name}</h2>
                </header>
                <dl className="p-5">
                    ...
                    <dd className="font-normal text-gray-400">Username: {robotUsername}</dd>
